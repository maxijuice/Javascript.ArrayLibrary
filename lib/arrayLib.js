...
var arrayLibrary = {
    chain: function(array) {
        ...
        return {
            ...
            /*take: function(n) {
                return self.chain(self.take(initialValue, n));
            },*/

            skip: wrapChain(self.skip),
            /* skip: function(n) {
                return self.chain(self.skip(initialValue, n));
            },*/

            map: function(callback) {
                return self.chain(self.map(initialValue, callback));
            },

            foreach: function(callback) {
                return self.chain(self.foreach(initialValue, callback));
            },

            filter: function(callback) {
                return self.chain(self.filter(initialValue, callback));
            },

            reduce: function(callback) {
                return self.chain(self.reduce(initialValue, callback));
            },
